...
describe('sendResetPasswordEmail', () => {
    test.each(testCases)('$description', async ({ showAlertArgs, formData, fetchWrapperMockResult}) => {
        ...
        await sendResetPasswordEmail(formData, showAlertFn, setFormErrorsFn, formErrorsState, setLoadingFn);
